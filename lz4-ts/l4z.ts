// lz4.ts - An implementation of Lz4 in plain JavaScript.
//
// TODO:
...
function makeHashTable(): Uint32Array | number[] {
  try {
...
// Clear hashtable.
function clearHashTable(table: Uint32Array | number[]): void {
  for (let i = 0; i < hashSize; i++) {
    hashTable[i] = 0;
  }
}
...
export function makeBuffer(size: number): Uint8Array | number[] {
  try {
...
function sliceArray(array: Uint8Array | number[], start: number, end: number): Uint8Array | number[] {
...
export function decompressBound(src: Uint8Array | number[]): number {
  let sIndex = 0;
  // Read magic number
...
// export const makeBuffer = makeBuffer;

export function decompressBlock(src: Uint8Array | number[], dst: Uint8Array | number[], sIndex: number, sLength: number, dIndex: number): number {
...
export function compressBlock(src: Uint8Array | number[], dst: Uint8Array | number[], sIndex: number, sLength: number, hashTable: Uint32Array | number[]): number {
...
export function decompressFrame(src: Uint8Array | number[], dst: Uint8Array | number[]): number {
...
export function compressFrame(src: Uint8Array | number[], dst: Uint8Array | number[]): number {
  let dIndex = 0;
  // Write magic number.
...
export function decompress(src: Uint8Array | number[], maxSize?: number): Uint8Array | number[] {
  let dst, size;
...
export function compress(src: Uint8Array | number[], maxSize?: number): Uint8Array | number[] {
  let dst, size;
  if (maxSize === undefined) {
