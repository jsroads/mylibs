...
function loadCC() {
    ...
    const firstScreen = require("./fast/first-screen");
    //初始化进度
    let progress = 0.10;
    firstScreen.start("fast/first.jpg", "default", "default", "false").then((image) => {
    ...
    function onApplicationCreated() {
        const {loadEngine, applicationStart} = require("./fast/application.js");
